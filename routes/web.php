...
return static function (Router $router): void {
    ...
    $router->post('/domains/import-from-accounts', [DomainsController::class, 'importFromAccounts'], [VerifyCsrfMiddleware::class, AuthMiddleware::class, 'perm:domains.manage']);
